...
public class Member_hapDTO {
	...
	public Member_hapDTO(int member_num, String member_id, String member_name, String member_passwd,
			String member_phone, String member_email, String member_birth, String member_fname,
			MultipartFile member_fnameMF, char member_grade) {
		super();
	...
	public String toString() {
		return "Member_hapDTO [member_num=" + member_num + ", member_id=" + member_id + ", member_name=" + member_name
				...
				+ member_email + ", member_birth=" + member_birth + ", member_fname=" + member_fname
				+ ", member_fnameMF=" + member_fnameMF + ", member_grade=" + member_grade + "]";
	}
