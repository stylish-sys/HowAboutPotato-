...
<body>
	<div class="container">
		<form class="form-horizontal" action="deleteNotice" method="post"
			...
			<input type="hidden" name="col" value="${param.col}>"> <input
				...
				type="hidden" name="notice_oldfile" value="${param.notice_oldfile}">

			<div class="form-group">
				<label class="control-label col-sm-2" for="notice_passwd">비밀번호</label>
				<div class="col-sm-6">
					<input type="password" class="form-control" id="notice_passwd"
						placeholder="Enter password" name="notice_passwd">
				</div>
			</div>
			<div class="form-group">
