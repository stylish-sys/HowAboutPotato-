...
<h1 class = "col-sm-offset-2 col-sm-10">사진수정</h1>
  <form class="form-horizontal" action="updateFile" method = "post" enctype = "multipart/form-data">
   ...
   <input type = "hidden" name = "board_num" value = "${param.board_num }">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="room_filenameMF">변경파일:</label>
      <div class="col-sm-6">          
        <input type="file" class="form-control" id="room_filenameMF" name="room_filenameMF" accept = ".jpg,.png,.gif" required="required">
      </div>
    </div>
    <div class="form-group">        
