...
public class Utility {
	...
	public static String paging_l(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
		int pagePerBlock = 5; // 블럭당 페이지 수
		int totalPage = (int) (Math.ceil((double) totalRecord / recordPerPage)); // 전체 페이지
		int totalGrp = (int) (Math.ceil((double) totalPage / pagePerBlock));// 전체 그룹
		int nowGrp = (int) (Math.ceil((double) nowPage / pagePerBlock)); // 현재 그룹
		...
		if (nowGrp >= 2) {
			str.append(
					"<li><a href='./member_list.do?col=" + col + "&word=" + word + "&nowPage=" + _nowPage + "'>이전</A></li>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nowPage == i) {
				...
				str.append("<li><a href='./member_list.do?col=" + col + "&word=" + word + "&nowPage=" + i + "'>" + i
						+ "</A></li>");
			}
		}
		...
		if (nowGrp < totalGrp) {
			str.append(
					"<li><A href='./member_list.do?col=" + col + "&word=" + word + "&nowPage=" + _nowPage + "'>다음</A></li>");
		}
		str.append("</ul>");
		str.append("</div>");
	...
	public static String paging_noti(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
		int pagePerBlock = 5; // 블럭당 페이지 수
		int totalPage = (int) (Math.ceil((double) totalRecord / recordPerPage)); // 전체 페이지
		int totalGrp = (int) (Math.ceil((double) totalPage / pagePerBlock));// 전체 그룹
		int nowGrp = (int) (Math.ceil((double) nowPage / pagePerBlock)); // 현재 그룹
		...
		if (nowGrp >= 2) {
			str.append(
					"<li><a href='./listNotice.do?col=" + col + "&word=" + word + "&nowPage=" + _nowPage + "'>이전</A></li>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nowPage == i) {
				...
				str.append("<li><a href='./listNotice.do?col=" + col + "&word=" + word + "&nowPage=" + i + "'>" + i
						+ "</A></li>");
			}
		}
		...
		if (nowGrp < totalGrp) {
			str.append(
					"<li><A href='./listNotice.do?col=" + col + "&word=" + word + "&nowPage=" + _nowPage + "'>다음</A></li>");
		}
		str.append("</ul>");
		str.append("</div>");
	...
	public static String paging_qna(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
		int pagePerBlock = 5; // 블럭당 페이지 수
		int totalPage = (int) (Math.ceil((double) totalRecord / recordPerPage)); // 전체 페이지
		int totalGrp = (int) (Math.ceil((double) totalPage / pagePerBlock));// 전체 그룹
		int nowGrp = (int) (Math.ceil((double) nowPage / pagePerBlock)); // 현재 그룹
		...
		if (nowGrp >= 2) {
			str.append(
					"<li><a href='./listQna.do?col=" + col + "&word=" + word + "&nowPage=" + _nowPage + "'>이전</A></li>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nowPage == i) {
				...
				str.append("<li><a href='./listQna.do?col=" + col + "&word=" + word + "&nowPage=" + i + "'>" + i
						+ "</A></li>");
			}
		}
		...
		if (nowGrp < totalGrp) {
			str.append(
					"<li><A href='./listQna.do?col=" + col + "&word=" + word + "&nowPage=" + _nowPage + "'>다음</A></li>");
		}
		str.append("</ul>");
		str.append("</div>");
	...
	public static String paging_acc(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
		int pagePerBlock = 5; // 블럭당 페이지 수
		int totalPage = (int) (Math.ceil((double) totalRecord / recordPerPage)); // 전체 페이지
		int totalGrp = (int) (Math.ceil((double) totalPage / pagePerBlock));// 전체 그룹
		int nowGrp = (int) (Math.ceil((double) nowPage / pagePerBlock)); // 현재 그룹
		...
		if (nowGrp >= 2) {
			str.append(
					"<li><a href='./res_acc.do?col=" + col + "&word=" + word + "&nowPage=" + _nowPage + "'>이전</A></li>");
		}
	...
	public static String rpaging(int total, int nowPage, int recordPerPage, String col, String word, String url,
		...
		if (nowGrp >= 2) {
			str.append("<li><a href='" + url + "?col=" + col + "&word=" + word + "&nowPage=" + nowPage + "&board_num="
					+ board_num + "&nPage=" + _nowPage + "'>이전</A></li>");
		}
		...
		if (nowGrp < totalGrp) {
			str.append("<li><A href='" + url + "?col=" + col + "&word=" + word + "&nowPage=" + nowPage + "&board_num="
					+ board_num + "&nPage=" + _nowPage + "'>다음</A></li>");
		}
		str.append("</ul>");
		str.append("</div>");
