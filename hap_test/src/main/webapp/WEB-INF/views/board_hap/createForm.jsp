	...
	<div class="container">
		...
		<form class="form-horizontal" action="create" method="post" name='frm'
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="board_filename">업소 소개 사진</label>
				<div class="col-sm-6">
					<input type="file" class="form-control" id="board_filename" name="board_filenameMF" accept=".jpg,.gif,.png">
				</div>
			</div>

			<div class="form-group">
				<label class="control-label col-sm-2" for="board_name"><span id="need">*</span>업소 이름</label>
				<div class="col-sm-3">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="board_account" placeholder="입금받을 계좌번호를 입력하세요" name="board_account">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<textarea rows="12" cols="6"  class = "form-control" id = "board_content" name = "board_content" 
