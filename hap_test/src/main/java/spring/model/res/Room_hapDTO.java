...
public class Room_hapDTO {
	...
	private MultipartFile room_filenameMF;	
	
	private Room_hapDTO room_hapDTO;
	private Board_hapDTO board_hapDTO;
	...
	public Room_hapDTO getRoom_hapDTO() {
		return room_hapDTO;
	}

	public void setRoom_hapDTO(Room_hapDTO room_hapDTO) {
		this.room_hapDTO = room_hapDTO;
	}

	public Board_hapDTO getBoard_hapDTO() {
		return board_hapDTO;
	}

	public void setBoard_hapDTO(Board_hapDTO board_hapDTO) {
		this.board_hapDTO = board_hapDTO;
	}
	...
	public Room_hapDTO(int room_num, String room_filename, int room_price, String room_name, String room_content,
			int room_max, int board_num, Board_hapDTO board_hapDTO, Room_hapDTO room_hapDTO) {
		super();
		this.room_num = room_num;
		this.room_filename = room_filename;
		this.room_price = room_price;
